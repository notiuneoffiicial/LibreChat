        ...
        <div className={cn('flex w-full items-center', isRTL && 'flex-row-reverse')}>
          ...
          >
            ...
            >
              ...
              <div data-tour="voice-dictation-controls" className="flex items-center gap-2">
                {SpeechToText && (
                  <AudioRecorder
                    methods={methods}
                    ask={submitMessage}
                ...
                <VoiceModeButton disabled={disableInputs || isNotAppendable} />
              </div>

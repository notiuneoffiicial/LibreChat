...
export async function loadDefaultInterface({
  ...
  const loadedInterface: AppConfig['interfaceConfig'] = removeNullishValues({
    ...
    modelSelectReadOnly: interfaceConfig?.modelSelectReadOnly,
    ...
    viewsMenu: interfaceConfig?.viewsMenu ?? defaults.viewsMenu,
    newsMenu: interfaceConfig?.newsMenu ?? defaults.newsMenu,
